...
<section class="container mb-5">
			...
			foreach ($comments as $comment) {
				...
				<div class="container row p-2 shadow border mb-4 ">
					<div class="col-9">
						...
						<p>Ecrit le : <?php echo date('d/m/Y',$comment->getDateCreation()); ?>  <span class="badge badge-warning text-right">Ce commentaire a été reporté par un utilisateur</span></p>
	...
	<div class="container">
		...
		?>			
					...
					<div class="col-9">
						<h3>Auteur : <?php echo $comment->getAuteur(); ?></h3>
						<p>Ecrit le : <?php echo date('d/m/Y',$comment->getDateCreation()); ?></p>
						<p>Contenu : <?php echo $comment->getContenu(); ?></p>
					</div>
